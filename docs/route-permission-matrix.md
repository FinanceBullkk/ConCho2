...
| `/api/learning/dashboard` | Admin/Teacher (`report.read`); Teacher class-scoped | none (read-only) | operational KPI bundle (2-tier dashboard Phase 1); composes rollup/assignment/certificate engines, fail-soft per metric |
