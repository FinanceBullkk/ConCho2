...
| `/api/english-training` | `domains/english-training/routes.js` | feature-flagged Admin/Coordinator operations view over imported English cohorts, runs, employees, historical sessions/attendance, derived eligibility, and DQ correction overlays; canonical `eng_*` history remains separate from live scheduling/attendance |
