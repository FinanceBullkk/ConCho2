...
// dashboard-stats-repository — all Mongoose access for the admin analytics
// dashboard. The controller keeps filter-building + the PHASE-2 in-process
// composition; this file owns the distinct dropdowns + the 14 parallel
// aggregations/finds (the largest single Mongo→SQL rewrite at the Postgres
// port). Phase 0 readiness — behaviour identical to the inline version.
