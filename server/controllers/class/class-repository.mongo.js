...
// class-repository — MONGO impl (Phase 3 Wave-F, extracted verbatim from the
// Phase-0 seam). All Mongoose calls for the legacy class read/mutation
// handlers; the controllers keep validation, audit, policy + the envelope.
