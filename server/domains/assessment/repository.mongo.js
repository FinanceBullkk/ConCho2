// assessment/repository — MONGO impl (Phase 3 Wave-B dual-backend port).
// Verbatim of the pre-port repository.js: assessment definitions + attempts +
// the unified-results / grading-queue reads. ./repository.pg mirrors this
