...
// ──────────────────────────────────────────────────────────
// attendance/repository — the single home for every Mongoose call in this
// domain (audit round 9: model access consolidated out of controller / marking
// / scope / analytics). Behaviour is preserved 1:1 — same filters, projections,
// populate, lean, sort and aggregation pipelines as the call sites they replace.
// The analytics pipelines live here (data-shaping); their scope resolution and
// in-memory rollups stay in ./analytics (orchestration).
// ──────────────────────────────────────────────────────────
