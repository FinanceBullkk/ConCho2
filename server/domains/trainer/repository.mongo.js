...
// ──────────────────────────────────────────────────────────
// trainer/repository — MONGO impl. Mongoose access for A6 (trainer-management
// depth, H2). Profiles live in TrainerProfile; load + free-at checks read
// Schedule (sessionInstructorIds). Candidate trainers come from User (Teacher/Admin).
