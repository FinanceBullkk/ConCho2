...
// ──────────────────────────────────────────────────────────
// learning/session/repository — MONGO impl (Phase 3 Wave-D, the last repo
// port). Read-only: every session WRITE goes through scheduleService (already
// fully dual-backend); this file is the learner/teacher/scheduler READ surface
// (list/detail hydration + the booking-adapter context lookups). The selector
// ./repository.js resolves this or ./repository.pg by DB_BACKEND.
// ──────────────────────────────────────────────────────────
