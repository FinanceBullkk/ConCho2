// learning/reports/repository — backend selector (Phase 3 Wave-B port).
// Consumers (completion-rollup / compliance / org-export / training-hours
// use-cases) keep `require('./repository')` unchanged; this resolves to the Mongo
