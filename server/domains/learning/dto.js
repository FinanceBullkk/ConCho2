...
const programDto = (program) => {
  ...
  return {
    ...
    englishPolicy: p.englishPolicy || null,
...
const cohortDto = (cohort, bookedSessions = 0) => {
  ...
  return {
    ...
    englishGroupCode: c.englishGroupCode || null,
    englishPolicySnapshot: c.englishPolicySnapshot || null,
    englishPicDisplay: c.englishPicDisplay || '',
