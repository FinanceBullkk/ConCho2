...
const { AUTHORITY, auditActor, iso, meetingWindow, rosterToken } = require('./canonical-operations-shared');

// Canonical English Meeting + attendance-roster commands: create a Meeting +
// first Session Unit, reschedule/cancel a planned Meeting, and read/save the
// exact Present/Absent roster. Mutations run in one PostgreSQL transaction with
// domain audit; delivery side-effects fire post-commit.
