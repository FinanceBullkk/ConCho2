/**
 * search-repository.js — all Mongoose access for cross-entity global search.
 *
 * Phase 0 (Postgres readiness): the searchService keeps the role-scoping policy,
 * caching, and result assembly; every collection query + Mongo-specific query
 * shape (anchored/substring regex, `$or`, soft-delete `$ne` predicate, populate)
 * lives here so the eventual Postgres port swaps THIS file only.
 *
