...
| QA-018b | P2 | 06 | Remaining persona-critical e2e specs after booking shipped: attendance mark > export download > MFA login (speakeasy codes) > waitlist join (full-capacity fixture) | Owner 2026-06-11: backlog, in that order |
